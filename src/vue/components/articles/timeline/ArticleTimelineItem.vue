<template>
    <li class="timeline-item"
        ...
        <ArticleTimelineItemContent
                                v-if="item"
                                :title="item.title"
                                :formatted-date-start="formatYear(item.date_start)"
                                :formatted-date-end="formatYear(item.date_end, true)"
...
const formatYear = (date, isEnd = false) => {
  if (!date && isEnd) return 'Actual'
  if (!date) return ''
